...
import pt.ul.fc.di.lasige.simhs.core.domain.scheduling.policies.LLFSchedulingPolicy;
import pt.ul.fc.di.lasige.simhs.core.domain.scheduling.taxonomy.IDPScheduler;

/**
 * @author jcraveiro
 *
 */
public class GLLFScheduler extends MultiprocessorGlobalScheduler  implements IDPScheduler {

	/**
	 * 
	 */
	public GLLFScheduler() {
		super();
	}
	...
	protected SchedulingPolicy getPolicy() {
		return new LLFSchedulingPolicy();
	}
