...
public class LLFSchedulingPolicy implements SchedulingPolicy {
	@Override
	public int compare(Job o1, Job o2) {

		int r1 = new Double(o1.getSlackTime()).compareTo(o2.getSlackTime());

		if (r1 != 0) {
			return r1;
		} else {
			int r2 = new Integer(o1.getReleaseTime()).compareTo(o2
					.getReleaseTime());
